...
def callback_modifier(ancien_id):
    ...
    # Si le nom change, on vérifie que le nouveau nom n'existe pas déjà ailleurs dans la base
    ...
    # Mise à jour de l'ID, de la PAS et de la PAD simultanément
...
if source_donnees == " Générer via le nom du Chef":
    with st.sidebar.form(key="form_initialisation"):
        ...
        bouton_valider = st.form_submit_button(" Saiair et Valider")
...
if not application_prete:
    ...
    if action == "Ajouter un étudiant":
        ...
        if len(st.session_state['df_charge']) > 0:
            ...
            # NOUVEAUTÉ : Champ texte pour changer aussi l'ID de l'étudiant
    ...
    section = st.sidebar.radio("Navigation Analyses", [
        ...
        "3. Analyse Relationnelle Bivariée ", 
        "4. Profils de Clustering K-Means ", 
    ...
    with conteneur_application:
        ...
        if section == "1. Registre des Patients":
            ...
            with st.form(key="form_recherche_registre"):
                ...
                bouton_chercher = st.form_submit_button(" Lancer la recherche")
        ...
        elif section == "2. Statistique Univariée ":
        ...
        elif section == "3. Analyse Relationnelle Bivariée ":
        ...
        elif section == "4. Profils de Clustering K-Means ":
        ...
        elif section == "5. Matrice d'Évaluation ":
